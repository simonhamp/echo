 ...
 */
export class RatchetChannel extends Channel {
    /**
     * The Ratchet client instance.
     *
     * @type {any}
     */
    socket: any;
    ...
    /**
     * Subscribe to a Ratchet channel.
     *
     * @return {object}
     */
    subscribe(): any {
     ...
     */
    listen(event: string, callback: Function): RatchetChannel {
